   ...
   public String result;
    ...
    protected String doInBackground(Void... params) {
        ...
        try{
           ...
           // String userCredentials = "1941e53d40a74b1ea934ccb4f528fa32";
            //String basicAuth =  new String(Base64.encode(userCredentials.getBytes(), Base64.DEFAULT));
            //httpurlconnection.setRequestProperty ("X-AIO-Key", "1941e53d40a74b1ea934ccb4f528fa32");
